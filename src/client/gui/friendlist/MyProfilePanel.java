...
//FriendListPanel에 들어가는 내 프로필 UI
import javax.swing.*;
...
public class MyProfilePanel extends JPanel {
    ...
    public MyProfilePanel(String name, String stateMessage) {
        ...
        ImageIcon profileImg = new ImageIcon("src/data/icon/free_people.png");
	    ...
	    JButton stateChange = new JButton("상태메시지");
		    HideButtonStyle.apply(stateChange);
